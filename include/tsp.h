...
namespace bms
{
    ...
    IndexDistance find_closest_vertex(const char* const MATRIX, DistanceMatrix& distanceMatrix, const std::size_t VERTEX, const std::vector<bool>& ALREADY_ADDED, const std::size_t SUBSAMPLED_ROWS, const std::size_t OFFSET, std::size_t& counter);
